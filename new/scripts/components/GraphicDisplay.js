    ...
    function style(theme, width) {
      ...
      return {
        ...
        data: combineState({
          ...
          starting: {
            font: fontSizePx(5) + ' Roboto', //Verdana',
            fillStyle: 'grey'
          },
          progress: {
            font: ' bold ' + fontSizePx(10) + ' Roboto',//  Verdana',
            fillStyle:'#fea500'// fillStyle
          },
          progressPlaying: {
            fillStyle: '#7cba00'
          },
          ended: {
            font: fontSizePx(8) + ' Roboto', //Verdana',
            fillStyle: 'red'
          }
        })
      };
    ...
    Graph.prototype.drawGameData = function() {
      ...
      case 'ENDED':
        ...
        ctx.fillText(
          ...
          this.canvasHeight / 2 - this.style.fontSizeNum(13) / 2
        );
        ...
        if (lastGame)
          ctx.fillText(
            ...
            this.canvasWidth / 2,
            this.canvasHeight / 2 + this.style.fontSizeNum(13) / 4
          );
        break;
      }
    };
