            ...
            if (this.state.username) {
                userLogin = D.div({
                    ...
                    D.div({
                        ...
                        D.span({
                            className: 'balance'
                        }, this.state.balanceBitsFormatted)
                    ),
                    D.div({
                            className: 'username'
                        },
            ...
            return D.div({
                ...
                D.div({
                    ...
                    D.a({
                        ...
                        /*D.h1(null, this.props.isMobileOrSmall ? 'BSQ' : 'BitSquare') :*/
                        D.img({
                            src: ((this.state.theme === 'white') ? '/img/top_logo.png' : '/img/top_logo_black.png') ,
                            className: "top-img-logo"
                        })
                    )
                ),
                D.div({
                        className: 'full-screen noselect',
                        onClick: this._toggleFullScreen
                    },
                    this.state.fullScreen ? D.i({
                ...
                D.div({
                        className: 'toggle-view noselect' + ((this.state.theme === 'white') ? ' black' : ' white'),
                        onClick: this._toggleTheme
                    },
                    D.a(null, (this.state.theme === 'white') ? 'Go black' : 'Go white')
                ),
